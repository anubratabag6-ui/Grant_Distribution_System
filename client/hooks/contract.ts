...
export const CONTRACT_ADDRESS =
  "CAKB3IZDRZ2FQNEPLVC7DUZ6DBPGSNX3FLURX4YXBAFNWCX74CG6QI54";
...
// ============================================================
// Grant Distribution System — Contract Methods
// ============================================================
 ...
 */
export async function initContract(caller: string, admin: string) {
  return callContract(
    "init",
...
/**
 * Admin assigns a grant to a recipient.
 * Calls: assign_grant(recipient: Address, amount: i128)
 */
export async function assignGrant(
  ...
  return callContract(
    "assign_grant",
    [toScValAddress(recipient), toScValI128(amount)],
    caller,
    true
  );
}
 ...
 * Calls: claim_grant(recipient: Address) -> i128
 * Returns: The grant amount claimed
 */
...
/**
 * Check grant amount for a recipient (read-only).
 * Calls: get_grant(recipient: Address) -> i128
 * Returns: The grant amount available
 */
